...
public class PantallaVerZoo {
    ...
    private Color getColorForHabitat(String tipo) {
        switch (tipo) {
            ...
            case "Río":
                return Color.web("#4682B4");
            case "Pantano":
                return Color.web("#556B2F");
            case "Océano Abierto":
                return Color.web("#00008B");
            case "Glaciares y Hielo Ártico":
                return Color.web("#F0FFFF");
            case "Montaña Rocosa":
                return Color.web("#708090");
            case "Aviario":
                return Color.web("#FFD700");
            case "Terrario":
                return Color.web("#8B4513");
            case "Acuario":
                return Color.web("#1E90FF");
            case "Zona Nocturna":
                return Color.web("#191970");
            default:
                return Color.GRAY;
        }
    }
